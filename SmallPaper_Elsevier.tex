...
\begin{figure}[h]
\begin{centering}
\includegraphics[scale=0.6]{SysExample}
\par\end{centering}
...
\begin{figure}[!h]
\centering{}\includegraphics[scale=0.6]{\string"impedance form\string".eps}\caption[Distance protection characteristic ]{Distance protection characteristic for system in Figure \ref{fig:System-Configuration-for-formulating-problem}
...
\begin{figure}[h]
\begin{centering}
\includegraphics[scale=0.6]{\string"IMpedance margin\string".eps}\caption{Impedance margin and impedance locus plot for a distance relay during
...
\begin{figure}[h]
\begin{centering}
\includegraphics[scale=0.7]{IEEE14BusSystemB}\caption{RCU and CCU of the solution in \citep{Lim2008}\label{fig:RCU-and-CCU} }
\par\end{centering}
\end{figure}
...
\begin{figure}[h]
\begin{centering}
\includegraphics[scale=0.5]{SynSE}\caption{Protection logic of the paper in \citep{navalkar2011secure}\label{fig:Protection-logic-ofSYNSE} }
\par\end{centering}
\end{figure}
...
\begin{figure}[h]
\begin{centering}
\includegraphics[scale=0.7]{loadblinder}\caption{Creation of adaptive load blinder in \citep{zadeh2011adaptive} \label{fig:Creation-of-adaptive}}
\par\end{centering}
\end{figure}
...
\begin{figure}[h]
\begin{centering}
\includegraphics[scale=0.6]{TZPA}\caption{TZMA and TZPA of the method in \citep{Nikolaidis2016}\label{fig:TZMA-and-TZPA} }
\par\end{centering}
\end{figure}
...
\phantomsection\addcontentsline{toc}{section}{\refname}\bibliography{References_used_in_proposal,newlit}
